...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.pre_survey'
        db.add_column(u'annote_article', 'pre_survey',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.post_survey'
        db.add_column(u'annote_article', 'post_survey',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.pre_survey'
        db.delete_column(u'annote_article', 'pre_survey')

        # Deleting field 'Article.post_survey'
        db.delete_column(u'annote_article', 'post_survey')
